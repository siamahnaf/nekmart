...
import { AddAddressData } from "@/Urql/Types/Checkout/checkout.types";
...
const AddAddress = ({ open, onClose }: Props) => {
    //State
    const [notification, setNotification] = useState<boolean>(false);

    //Urql
    const [{ data, error, fetching }, mutate] = useMutation<AddAddressData>(ADD_ADDRESS);
