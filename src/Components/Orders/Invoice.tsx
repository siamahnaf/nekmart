        ...
        <div className="">
            <div className="grid grid-cols-2 gap-5">
                ...
                <div className="text-right mt-4">
                    <QRCode value={data?.getSingleOrderBySeller.order?.orderId as string} size={80} className="ml-auto" />
            ...
            <div className="mt-8">
                ...
                <div className="flex gap-5 text-[15px] mt-2">
                    ...
                    <span className="text-main font-bold">৳{data?.getSingleOrderBySeller.price as number + Number(data?.getSingleOrderBySeller.products.reduce((a, b) => a + b.tax, 0))}</span>
                </div>
            </div>
