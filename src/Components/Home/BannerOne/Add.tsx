...
import { AddBannerOneData, GetBannerOneData } from "@/Urql/Types/Home/banner-one.types";
...
const Add = () => {
    ...
    //Urql
    const [{ data, error, fetching }, mutate] = useMutation<AddBannerOneData>(ADD_BANNER_ONE);
