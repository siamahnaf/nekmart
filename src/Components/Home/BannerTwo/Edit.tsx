...
import { UpdateBannerTwoData, GetBannerTwoData } from "@/Urql/Types/Home/banner-two.types";
import { BannerData } from "@/Urql/Types/Home/banner-one.types";
...
const Edit = ({ open, onClose, banners }: Props) => {
    ...
    const [{ data, error, fetching }, mutate] = useMutation<UpdateBannerTwoData>(UPDATE_BANNER_TWO);
