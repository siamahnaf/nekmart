...
const CartButton = ({ sellerId, reserved, attributes, minPurchase, onError, hasAttributes, attributeLength }: Props) => {
    //Initializing Hooks
    ...
    return (
        <div className="relative">
            ...
            <button className={`w-full py-2.5 bg-[#dd9f08] text-sm font-semibold mb-3 text-white rounded-lg relative ${reserved < Number(minPurchase) ? "opacity-60" : ""}`} disabled={reserved < Number(minPurchase)} onClick={onCartHandler}>
                Add to Cart
