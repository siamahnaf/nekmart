...
import { AddRootCategoryData } from "@/Urql/Types/RootCategories/root.types";
...
const Create = () => {
    ...
    //Urql
    const [{ data, error, fetching }, mutate] = useMutation<AddRootCategoryData>(ADD_ROOT_CATEGORY);
